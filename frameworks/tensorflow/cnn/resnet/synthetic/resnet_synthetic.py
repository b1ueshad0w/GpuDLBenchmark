...
from frameworks.tensorflow.cnn.resnet.synthetic.resnet_train import train, set_parameters, get_device_str
from frameworks.tensorflow.cnn.resnet.synthetic.resnet import *
